...
// Validate checks the field values on GetDecorationRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetDecorationRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetDecorationRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetDecorationRequestMultiError, or nil if none found.
func (m *GetDecorationRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *GetDecorationRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetDecorationRequestMultiError(errors)
	}

	return nil
}

// GetDecorationRequestMultiError is an error wrapping multiple validation
// errors returned by GetDecorationRequest.ValidateAll() if the designated
// constraints aren't met.
type GetDecorationRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetDecorationRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetDecorationRequestMultiError) AllErrors() []error { return m }

// GetDecorationRequestValidationError is the validation error returned by
// GetDecorationRequest.Validate if the designated constraints aren't met.
type GetDecorationRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetDecorationRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetDecorationRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetDecorationRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetDecorationRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetDecorationRequestValidationError) ErrorName() string {
	return "GetDecorationRequestValidationError"
}

// Error satisfies the builtin error interface
func (e GetDecorationRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetDecorationRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetDecorationRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetDecorationRequestValidationError{}
